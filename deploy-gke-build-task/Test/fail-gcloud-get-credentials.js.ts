 ...
 *   a failure in the "gcloud container clusters get-credentials" call.
...
const answers: TaskLibAnswers = mocks.getDefaultAnswers();
answers.exec[tc.clusterCredentialExecString] = tc.failResult;
